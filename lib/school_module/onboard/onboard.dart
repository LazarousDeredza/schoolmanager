...
import 'package:schoolmanager/school_module/constants/colors.dart';
import 'package:schoolmanager/school_module/views/screens/splash_screen.dart';
...
class _OnBoardState extends State<OnBoard> {
  ...
  List<OnboardModel> screens = <OnboardModel>[
    OnboardModel(
      ...
      text: "Welcome to School Manager Appplication",
      desc: "We are proud to offer a range of top quality School Management services",
      bg: Colors.white,
    ...
    OnboardModel(
      ...
      text: "Reliability",
      desc: "This app is very reliable",
      bg: Colors.white,
